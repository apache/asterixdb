...
public abstract class AbstractQuadStringStringEval implements ICopyEvaluator   {
    ...
    private ISerializerDeserializer nullSerde = AqlSerializerDeserializerProvider.INSTANCE.getSerializerDeserializer(BuiltinType.ANULL);
    private ISerializerDeserializer strSerde = AqlSerializerDeserializerProvider.INSTANCE.getSerializerDeserializer(BuiltinType.ASTRING);

    public AbstractQuadStringStringEval(DataOutput dout, ICopyEvaluatorFactory eval0,
            ICopyEvaluatorFactory eval1, ICopyEvaluatorFactory eval2, ICopyEvaluatorFactory eval3) throws AlgebricksException {
        this.dout = dout;
    ...
    protected abstract String compute(byte[] b0, int l0, int s0,
            byte[] b1, int l1, int s1, byte[] b2, int l2, int s2,
            byte[] b3, int l3, int s3,
