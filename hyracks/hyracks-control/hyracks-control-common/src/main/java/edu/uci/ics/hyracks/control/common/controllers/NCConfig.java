...
public class NCConfig implements Serializable {
    ...
    @Option(name = "-iodevices", usage = "Comma separated list of IO Device mount points (default: Two devices in default temp folder)", required = false)
    public String ioDevices = System.getProperty("java.io.tmpdir") + File.separator + "iodevice0" + ","
            + System.getProperty("java.io.tmpdir") + File.separator + "iodevice1";
    ...
    public void toMap(Map<String, String> configuration) {
        ...
        configuration.put("result-history-size", String.valueOf(resultHistorySize));
