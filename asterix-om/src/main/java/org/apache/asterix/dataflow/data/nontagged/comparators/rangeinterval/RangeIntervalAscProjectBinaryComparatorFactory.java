...
public class RangeIntervalAscProjectBinaryComparatorFactory implements IBinaryComparatorFactory {

    private static final long serialVersionUID = 1L;

    public static final RangeIntervalAscProjectBinaryComparatorFactory INSTANCE = new RangeIntervalAscProjectBinaryComparatorFactory();

    private RangeIntervalAscProjectBinaryComparatorFactory() {
