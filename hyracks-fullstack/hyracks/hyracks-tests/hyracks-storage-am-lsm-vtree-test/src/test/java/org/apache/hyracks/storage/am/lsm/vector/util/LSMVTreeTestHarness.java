...
public class LSMVTreeTestHarness {
    ...
    protected IVTreeDataTupleBuilderFactory dataTupleBuilderFactory;
    ...
    public void setUp() throws HyracksDataException {
        ...
        ioDeviceId = 0;
        onDiskDir = ioManager.getIODevices().get(ioDeviceId).getMount() + sep + "lsm_vtree_"
    ...
    public IVTreeDataTupleBuilderFactory getDataTupleBuilderFactory() {
        return dataTupleBuilderFactory;
    }
}
