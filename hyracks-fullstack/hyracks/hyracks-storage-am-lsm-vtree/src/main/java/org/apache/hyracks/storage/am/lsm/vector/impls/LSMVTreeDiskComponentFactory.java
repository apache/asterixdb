 ...
 * which contain materialized VTree instances that have been
 * flushed from memory to persistent storage.
 */
public class LSMVTreeDiskComponentFactory implements ILSMDiskComponentFactory {

    protected final TreeIndexFactory<VTree> vTreeFactory;
    protected final IComponentFilterHelper filterHelper;

    public LSMVTreeDiskComponentFactory(TreeIndexFactory<VTree> vTreeFactory, IComponentFilterHelper filterHelper) {
    ...
    public LSMVTreeDiskComponent createComponent(AbstractLSMIndex lsmIndex, LSMComponentFileReferences cfr)
        ...
        return new LSMVTreeDiskComponent(lsmIndex, vTreeFactory.createIndexInstance(cfr.getInsertIndexFileReference()),
