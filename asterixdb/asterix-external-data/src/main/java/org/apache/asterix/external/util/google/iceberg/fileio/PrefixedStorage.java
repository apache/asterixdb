...
/**
 * Copy of {@link <a href="https://github.com/apache/iceberg/blob/apache-iceberg-1.10.0/gcp/src/main/java/org/apache/iceberg/gcp/gcs/PrefixedStorage.java">PrefixedStorage</a>}
        ...
        if (null == storage) {
            this.storage = () -> {
                ...
                if (gcpProperties.oauth2Token().isPresent()) {
                    ...
                    try {
                        builder.setCredentials(GCSUtils.buildCredentials(null, gcpProperties.properties(), null));
                    } catch (Exception e) {
