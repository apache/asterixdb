...
public class NoOpIcebergTableFilterEvaluatorFactory extends IcebergTableFilterEvaluatorFactory {
    public static final IExternalFilterEvaluatorFactory INSTANCE = new NoOpIcebergTableFilterEvaluatorFactory();
