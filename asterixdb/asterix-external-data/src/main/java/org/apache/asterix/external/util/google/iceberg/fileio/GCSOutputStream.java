...
/**
 * Copy of {@link <a href="https://github.com/apache/iceberg/blob/apache-iceberg-1.10.0/gcp/src/main/java/org/apache/iceberg/gcp/gcs/GCSOutputStream.java">GCSOutputStream</a>}
...
class GCSOutputStream extends PositionOutputStream {
    ...
    GCSOutputStream(Storage storage, BlobId blobId, GCPProperties gcpProperties, MetricsContext metrics)
            throws IOException {
    ...
    private void openStream() {
        ...
        gcpProperties.userProject()
                .ifPresent(userProject -> writeOptions.add(BlobWriteOption.userProject(userProject)));

        WriteChannel channel =
                storage.writer(BlobInfo.newBuilder(blobId).build(), writeOptions.toArray(new BlobWriteOption[0]));
