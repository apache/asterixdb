...
public class IcebergSnapshotUtils {
    ...
    public static Optional<Long> validateAndGetSnapshot(Map<String, String> properties) throws CompilationException {
        ...
        String timeZoneId = properties.get(ExternalDataConstants.IcebergOptions.TIMEZONE);
        ZoneId zoneId = timeZoneId != null ? ZoneId.of(timeZoneId) : ZoneOffset.UTC;
    ...
    private static long parseTimestamp(String timestamp, ZoneId zoneId) throws CompilationException {
        try {
        ...
        try {
            ...
            return LocalDate.parse(timestamp, ISO_LOCAL_DATE).atStartOfDay(zoneId).toInstant().toEpochMilli();
