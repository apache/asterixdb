...
/**
 * Copy of {@link <a href="https://github.com/apache/iceberg/blob/apache-iceberg-1.10.0/gcp/src/main/java/org/apache/iceberg/gcp/gcs/GCSOutputFile.java">GCSOutputFile</a>}
 * for visibility reasons.
 */
class GCSOutputFile extends BaseGCSFile implements OutputFile {

    static GCSOutputFile fromLocation(String location, PrefixedStorage storage, MetricsContext metrics) {
        return new GCSOutputFile(storage.storage(), BlobId.fromGsUtilUri(location), storage.gcpProperties(), metrics);
    }
