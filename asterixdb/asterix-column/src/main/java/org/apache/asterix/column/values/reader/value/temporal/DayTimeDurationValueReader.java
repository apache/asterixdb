...
public class DayTimeDurationValueReader extends AbstractValueReader {
    private final ParquetDeltaBinaryPackingValuesReader dayTimeDurationValueReader;
    private long nextValue;

    public DayTimeDurationValueReader() {
        dayTimeDurationValueReader = new ParquetDeltaBinaryPackingValuesReader();
    }

    @Override
    public void init(AbstractBytesInputStream in, int tupleCount) throws IOException {
        dayTimeDurationValueReader.initFromPage(in);
    }

    @Override
    public void nextValue() {
        nextValue = dayTimeDurationValueReader.readLong();
    }
    ...
    public void skip(int count) {
        dayTimeDurationValueReader.skip(count);
    }
