...
public enum ErrorCode implements IError {
    ...
    ICEBERG_FILTER_NOT_PUSHED(73),
    ICEBERG_VARIANT_PROJECTION_NOT_PUSHED(74),
    ICEBERG_VARIANT_BOUNDS_NOT_EVALUATED(75),
    TIME_ZONE_ID_IGNORED(76),
    UNSUPPORTED_JRE(100),
    ...
    ESTIMATED_COLUMN_COUNT_NOT_APPLICABLE_TO_TYPE(1225),
    CATALOG_EXISTS(1226),
    UNKNOWN_CATALOG(1227),
    UNSUPPORTED_CATALOG_TYPE(1228),
    ICEBERG_CATALOG_SOURCE_REQUIRED(1229),
    UNSUPPORTED_ICEBERG_CATALOG_SOURCE(1230),
    NON_CONTEXT_VARIABLE_ACCESS(1231),
    ...
    UPDATE_INSERT_POSITION_OUT_OF_BOUNDS(1252),
    ASYNC_NOT_SUPPORTED_FOR_STATEMENT(1253),
    UNSUPPORTED_FILE_IO_TYPE(1254),
    INVALID_FULL_SCAN_OPTION(1255), // not used, remove if not shipped yet
    INVALID_SAMPLE_METHOD(1256),
    COMPILATION_ANN_DISTANCE_METRIC_MISMATCH(1257), // not used, remove if not shipped yet
    COMPILATION_VECTOR_INDEX_CREATION_FAILED(1258),
    UNSUPPORTED_MULTIPLE_STATEMENTS_FOR_DELIVERY_MODE(1259),
    UNSUPPORTED_VECTOR_ELEMENT_TYPE(1260),
    VECTOR_DIMENSION_MISMATCH(1261),
    VENDED_CREDENTIALS_UNSUPPORTED_CATALOG_SOURCE(1262),
    ANALYZE_NOT_SUPPORTED_ON_EXTERNAL_DATASET(1263),
