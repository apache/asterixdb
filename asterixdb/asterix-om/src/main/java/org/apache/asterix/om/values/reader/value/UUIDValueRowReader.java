...
//
//public final class UUIDValueRowReader extends AbstractRowValueReader {
//    private final ParquetRowPlainFixedLengthValuesReader uuidReader;
//    private IValueReference nextValue;
//
//    public UUIDValueRowReader() {
//        ArrayBackedValueStorage storage = new ArrayBackedValueStorage(16);
//        uuidReader = new ParquetRowPlainFixedLengthValuesReader(storage);
//    }
//
//    @Override
