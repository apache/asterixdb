...
public final class ByteRowBufferInputStream extends AbstractRowBytesInputStream {
    private ByteBuffer buffer;
    private int mark = -1;

    @Override
    public void reset(IRowBufferProvider bufferProvider) {
    ...
    public void resetAt(int bytesToSkip, AbstractRowBytesInputStream stream) throws IOException {
        ByteRowBufferInputStream in = (ByteRowBufferInputStream) stream;
    ...
    public AbstractRowBytesInputStream sliceStream(int length) throws EOFException {
        ...
        ByteRowBufferInputStream in = new ByteRowBufferInputStream();
        in.addBuffer(copy);
        buffer.position(buffer.position() + length);
        return in;
    }
    ...
    @Override
    public AbstractRowBytesInputStream remainingStream() {
