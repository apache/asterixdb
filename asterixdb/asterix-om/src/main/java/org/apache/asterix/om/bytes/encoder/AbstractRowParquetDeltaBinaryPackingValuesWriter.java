...
//import org.apache.asterix.om.bytes.ParquetRowDeltaBinaryPackingConfig;
...
// */
//public abstract class AbstractRowParquetDeltaBinaryPackingValuesWriter extends AbstractRowParquetValuesWriter {
//
//    public static final int DEFAULT_NUM_BLOCK_VALUES = 128;
//
//    public static final int DEFAULT_NUM_MINIBLOCKS = 4;
//
//    protected final MultiRowTemporaryBufferBytesOutputStream outputStream;
//
//    /**
//     * stores blockSizeInValues, miniBlockNumInABlock and miniBlockSizeInValues
//     */
//    protected final ParquetRowDeltaBinaryPackingConfig config;
//
//    /**
...
//
//    protected AbstractRowParquetDeltaBinaryPackingValuesWriter(int blockSizeInValues, int miniBlockNum,
//            Mutable<IRowWriteMultiPageOp> multiPageOpRef) {
//        this.config = new ParquetRowDeltaBinaryPackingConfig(blockSizeInValues, miniBlockNum);
