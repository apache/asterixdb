...
//
//public class ParquetRowDeltaLengthByteArrayValuesReader extends AbstractRowParquetValuesReader {
//
//    private final VoidPointable value;
//    private final AbstractRowParquetValuesReader lengthReader;
//    private AbstractRowBytesInputStream in;
//
//    public ParquetRowDeltaLengthByteArrayValuesReader() {
//        this.lengthReader = new ParquetRowDeltaBinaryPackingValuesReader();
//        value = new VoidPointable();
//    }
//
//    @Override
//    public void initFromPage(AbstractRowBytesInputStream stream) throws IOException {
//        AbstractRowBytesInputStream lengthStream = stream.sliceStream(BytesUtils.readUnsignedVarInt(stream));
