...
public class RecordAddTypeComputer extends AbstractRecordFunctionTypeComputer {
    ...
    public IAType computeTypeImpl(AbstractFunctionCallExpression functionCallExpression, IAType arg0InRecType,
        ...
        if (tag2 == ATypeTag.MISSING) {
            return wrapTypeWithUnknown(arg0InRecType, isOutputMissable, isOutputNullable);
        }
        ...
        if (!Arrays.asList(inputRecordType.getFieldNames()).contains(newFieldName)) {
            ...
            if (actualType2.getTypeTag() == ATypeTag.ANY) {
                outputRecordType = new ARecordType(outputTypeName, inputRecordType.getFieldNames(),
