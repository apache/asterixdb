...
public interface IRowValuesWriterFactory {
    /**
     * Create a writer
     *
     ...
     * @return a writer
     */
    IRowValuesWriter createValueWriter(ATypeTag tag, int columnIndex, int level, boolean writeAlways, boolean filtered);
}
