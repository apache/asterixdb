...
//import org.apache.asterix.om.values.writer.filters.UUIDRowFilterWriter;
//import org.apache.commons.lang3.mutable.Mutable;
//
//final class UUIDRowValuesWriter extends StringRowValuesWriter {
//
//    public UUIDRowValuesWriter(Mutable<IRowWriteMultiPageOp> multiPageOpRef, int columnIndex, int level,
//            boolean collection, boolean filtered) {
//        // UUID is always written without encoding
//        super(columnIndex, level, collection, filtered, false,
//                new ParquetRowPlainFixedLengthValuesWriter(multiPageOpRef));
//    }
//
//    @Override
//    protected AbstractRowFilterWriter createFilter() {
//        return new UUIDRowFilterWriter();
//    }
//
//    @Override
