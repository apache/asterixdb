...
// * under the License.
// */
//package org.apache.asterix.om.bytes;
//
...
// */
//public class ParquetRowDeltaBinaryPackingConfig {
//    private int blockSizeInValues;
//    private int miniBlockNumInABlock;
//    private int miniBlockSizeInValues;
//
//    public ParquetRowDeltaBinaryPackingConfig(int blockSizeInValues, int miniBlockNumInABlock) {
...
//    }
//
//    public static ParquetRowDeltaBinaryPackingConfig readConfig(InputStream in,
//            ParquetRowDeltaBinaryPackingConfig config) throws IOException {
...
//        if (config == null) {
//            return new ParquetRowDeltaBinaryPackingConfig(blockSizeInValues, miniBlockNumInABlock);
//        }
