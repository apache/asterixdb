...
//
//public interface IRowValuesReaderFactory {
//    /**
...
//     */
//    IRowValuesReader createValueReader(ATypeTag typeTag, int columnIndex, int maxLevel, boolean primaryKey);
//
//    /**
...
//     * @return columnar reader
//     */
//    IRowValuesReader createValueReader(ATypeTag typeTag, int columnIndex, int maxLevel, int[] delimiters);
//
//    /**
...
//     */
//    IRowValuesReader createValueReader(DataInput input) throws IOException;
//}
