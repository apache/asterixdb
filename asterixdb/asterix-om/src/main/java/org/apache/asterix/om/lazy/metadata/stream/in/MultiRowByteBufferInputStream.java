 ...
 * under the License.
 */
package org.apache.asterix.om.lazy.metadata.stream.in;
...
import org.apache.asterix.om.api.IRowBufferProvider;
import org.apache.hyracks.api.exceptions.HyracksDataException;
import org.apache.hyracks.data.std.api.IPointable;
import org.apache.hyracks.data.std.util.ArrayBackedValueStorage;

public final class MultiRowByteBufferInputStream extends AbstractRowBytesInputStream {
    ...
    public MultiRowByteBufferInputStream() {
    ...
    private MultiRowByteBufferInputStream(MultiRowByteBufferInputStream original, int len) throws EOFException {
    ...
    @Override
    public void reset(IRowBufferProvider bufferProvider) throws HyracksDataException {
        reset();
    ...
    @Override
    public void resetAt(int bytesToSkip, AbstractRowBytesInputStream stream) throws IOException {
        MultiRowByteBufferInputStream original = (MultiRowByteBufferInputStream) stream;
        buffers.clear();
        position = original.position;
        length = original.length;
    ...
    @Override
    public AbstractRowBytesInputStream sliceStream(int length) throws EOFException {
        return new MultiRowByteBufferInputStream(this, length);
    }

    @Override
    public AbstractRowBytesInputStream remainingStream() throws EOFException {
        return new MultiRowByteBufferInputStream(this, length - position);
    }
