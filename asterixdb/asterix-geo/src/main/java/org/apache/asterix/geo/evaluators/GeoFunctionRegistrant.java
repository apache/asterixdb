...
import org.apache.asterix.geo.evaluators.functions.STCollectionExtractDescriptor;
import org.apache.asterix.geo.evaluators.functions.STConcaveHullDescriptor;
...
import org.apache.asterix.geo.evaluators.functions.STGeometryNOGCDescriptor;
import org.apache.asterix.geo.evaluators.functions.STGeometryTypeOGCDescriptor;
import org.apache.asterix.geo.evaluators.functions.STInteriorRingNDescriptor;
import org.apache.asterix.geo.evaluators.functions.STInteriorRingNOGCDescriptor;
...
import org.apache.asterix.geo.evaluators.functions.STIsValidReasonDescriptor;
...
import org.apache.asterix.geo.evaluators.functions.STLineMergeDescriptor;
...
import org.apache.asterix.geo.evaluators.functions.STMultiDescriptor;
...
import org.apache.asterix.geo.evaluators.functions.STNormalizeDescriptor;
...
import org.apache.asterix.geo.evaluators.functions.STNumPointsOGCDescriptor;
...
import org.apache.asterix.geo.evaluators.functions.STPointNOGCDescriptor;
import org.apache.asterix.geo.evaluators.functions.STPointOnSurfaceDescriptor;
...
import org.apache.asterix.geo.evaluators.functions.STRelateMatchDescriptor;
...
import org.apache.asterix.geo.evaluators.functions.STSimplifyDescriptor;
import org.apache.asterix.geo.evaluators.functions.STSimplifyPreserveTopologyDescriptor;
...
import org.apache.asterix.geo.evaluators.functions.STUnaryUnionDescriptor;
...
public class GeoFunctionRegistrant implements IFunctionRegistrant {
    ...
    public void register(IFunctionCollection fc) {
        ...
        fc.add(STConcaveHullDescriptor.FACTORY);
        fc.add(STSimplifyDescriptor.FACTORY);
        fc.add(STSimplifyPreserveTopologyDescriptor.FACTORY);
        fc.add(STPointOnSurfaceDescriptor.FACTORY);
        fc.add(STLineMergeDescriptor.FACTORY);
        fc.add(STGeometryTypeOGCDescriptor.FACTORY);
        fc.add(STPointNOGCDescriptor.FACTORY);
        fc.add(STGeometryNOGCDescriptor.FACTORY);
        fc.add(STInteriorRingNOGCDescriptor.FACTORY);
        fc.add(STNumPointsOGCDescriptor.FACTORY);
        fc.add(STMultiDescriptor.FACTORY);
        fc.add(STCollectionExtractDescriptor.FACTORY);
        fc.add(STUnaryUnionDescriptor.FACTORY);
        fc.add(STNormalizeDescriptor.FACTORY);
        fc.add(STIsValidReasonDescriptor.FACTORY);
        fc.add(STRelateMatchDescriptor.FACTORY);
    }
}
