...
public class STConcaveHullDescriptor extends AbstractScalarFunctionDynamicDescriptor {

    public static final IFunctionDescriptorFactory FACTORY = STConcaveHullDescriptor::new;

    private static final long serialVersionUID = 1L;

    @Override
    public FunctionIdentifier getIdentifier() {
        return BuiltinFunctions.ST_CONCAVE_HULL;
    }
    ...
    public IScalarEvaluatorFactory createEvaluatorFactory(final IScalarEvaluatorFactory[] args) {
        return new IScalarEvaluatorFactory() {
            ...
            public IScalarEvaluator createScalarEvaluator(IEvaluatorContext ctx) throws HyracksDataException {
                return new STConcaveHullEvaluator(args, ctx);
            }
        };
    }

    private class STConcaveHullEvaluator implements IScalarEvaluator {
        ...
        public STConcaveHullEvaluator(IScalarEvaluatorFactory[] args, IEvaluatorContext ctx)
        ...
        public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
            ...
            double lengthRatio = ATypeHierarchy.getDoubleValue(getIdentifier().getName(), 1, bytes1, offset1);
            ...
            try {
                Geometry hull = ConcaveHull.concaveHullByLengthRatio(geometry, lengthRatio);
                out.writeByte(ATypeTag.SERIALIZED_GEOMETRY_TYPE_TAG);
                AGeometrySerializerDeserializer.INSTANCE.serialize(hull, out);
            } catch (IOException e) {
