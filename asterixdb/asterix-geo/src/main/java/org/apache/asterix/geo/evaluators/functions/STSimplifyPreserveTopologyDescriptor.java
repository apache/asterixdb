...
public class STSimplifyPreserveTopologyDescriptor extends AbstractScalarFunctionDynamicDescriptor {

    public static final IFunctionDescriptorFactory FACTORY = STSimplifyPreserveTopologyDescriptor::new;

    private static final long serialVersionUID = 1L;

    @Override
    public FunctionIdentifier getIdentifier() {
        return BuiltinFunctions.ST_SIMPLIFY_PRESERVE_TOPOLOGY;
    }
    ...
    public IScalarEvaluatorFactory createEvaluatorFactory(final IScalarEvaluatorFactory[] args) {
        return new IScalarEvaluatorFactory() {
            ...
            public IScalarEvaluator createScalarEvaluator(IEvaluatorContext ctx) throws HyracksDataException {
                return new STSimplifyPreserveTopologyEvaluator(args, ctx);
            }
        };
    }

    private class STSimplifyPreserveTopologyEvaluator implements IScalarEvaluator {
        ...
        public STSimplifyPreserveTopologyEvaluator(IScalarEvaluatorFactory[] args, IEvaluatorContext ctx)
        ...
        public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
            ...
            double tolerance = ATypeHierarchy.getDoubleValue(getIdentifier().getName(), 1, bytes1, offset1);
            ...
            try {
                ...
                AGeometrySerializerDeserializer.INSTANCE.serialize(simplified, out);
            } catch (IOException e) {
