...
public class STDWithinDescriptor extends AbstractScalarFunctionDynamicDescriptor {

    public static final IFunctionDescriptorFactory FACTORY = STDWithinDescriptor::new;
    ...
    private class STDWithinEvaluator implements IScalarEvaluator {
        ...
        public STDWithinEvaluator(IScalarEvaluatorFactory[] args, IEvaluatorContext ctx) throws HyracksDataException {
        ...
        public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
            ...
            double distance = ATypeHierarchy.getDoubleValue(getIdentifier().getName(), 2, bytes2, offset2);
