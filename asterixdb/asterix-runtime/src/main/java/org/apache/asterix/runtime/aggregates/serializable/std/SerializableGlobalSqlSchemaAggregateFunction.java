...
public class SerializableGlobalSqlSchemaAggregateFunction extends AbstractSerializableAvgAggregateFunction {

    public SerializableGlobalSqlSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
