...
public class SerializableIntermediateSchemaAggregateFunction extends AbstractSerializableAvgAggregateFunction {

    public SerializableIntermediateSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
