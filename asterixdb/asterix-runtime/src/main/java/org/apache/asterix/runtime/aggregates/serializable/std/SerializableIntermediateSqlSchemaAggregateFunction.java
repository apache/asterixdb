...
public class SerializableIntermediateSqlSchemaAggregateFunction extends AbstractSerializableAvgAggregateFunction {

    public SerializableIntermediateSqlSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
