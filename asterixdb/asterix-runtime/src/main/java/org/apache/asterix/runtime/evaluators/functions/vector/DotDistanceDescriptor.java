...
public class DotDistanceDescriptor extends AbstractScalarFunctionDynamicDescriptor {
    ...
    public final static IFunctionDescriptorFactory FACTORY = DotDistanceDescriptor::new;

    @Override
    public FunctionIdentifier getIdentifier() {
        return BuiltinFunctions.DOT_DISTANCE;
    }
        ...
        return new IScalarEvaluatorFactory() {
            ...
            public IScalarEvaluator createScalarEvaluator(final IEvaluatorContext ctx) throws HyracksDataException {
                return new VectorDistanceScalarEvaluator(ctx, args, getIdentifier(),
                        VectorDistanceCalculation::dotDistance, sourceLoc);
            }
        };
