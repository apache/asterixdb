...
public class SerializableIntermediateSchemaAggregateDescriptor
        extends AbstractSerializableAggregateFunctionDynamicDescriptor {

    private static final long serialVersionUID = 1L;
    public static final IFunctionDescriptorFactory FACTORY = SerializableIntermediateSchemaAggregateDescriptor::new;

    @Override
    public FunctionIdentifier getIdentifier() {
        return BuiltinFunctions.SERIAL_INTERMEDIATE_AVG;
    }
    ...
    public ISerializedAggregateEvaluatorFactory createSerializableAggregateEvaluatorFactory(
        ...
        return new ISerializedAggregateEvaluatorFactory() {
            ...
            public ISerializedAggregateEvaluator createAggregateEvaluator(IEvaluatorContext ctx)
                ...
                return new SerializableIntermediateSchemaAggregateFunction(args, ctx, sourceLoc);
            }
        };
    }
