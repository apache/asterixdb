...
public class SerializableGlobalSchemaAggregateFunction extends AbstractSerializableAvgAggregateFunction {

    public SerializableGlobalSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
