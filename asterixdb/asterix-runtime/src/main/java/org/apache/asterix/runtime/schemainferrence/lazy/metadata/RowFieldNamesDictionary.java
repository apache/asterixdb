...
public class RowFieldNamesDictionary {
    ...
    public RowFieldNamesDictionary() {
        this(new ArrayList<>(), new Object2IntOpenHashMap<>(), new Int2IntOpenHashMap());
    }

    private RowFieldNamesDictionary(List<IValueReference> fieldNames,
    ...
    public static RowFieldNamesDictionary deserialize(DataInput input) throws IOException {
        ...
        return new RowFieldNamesDictionary(fieldNames, declaredFieldNamesToIndexMap, hashToFieldNameIndexMap);
    }
