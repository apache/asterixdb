...
public class GlobalSqlSchemaAggregateFunction extends AbstractSchemaAggregateFunction {

    public GlobalSqlSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
