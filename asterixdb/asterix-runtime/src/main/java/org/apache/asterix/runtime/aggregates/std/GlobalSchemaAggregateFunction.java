...
public class GlobalSchemaAggregateFunction extends AbstractSchemaAggregateFunction {

    public GlobalSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
