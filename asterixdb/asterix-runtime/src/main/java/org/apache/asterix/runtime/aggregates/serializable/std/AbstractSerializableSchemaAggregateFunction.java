...
public abstract class AbstractSerializableSchemaAggregateFunction extends AbstractSerializableAggregateFunction {
    ...
    public AbstractSerializableSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
    ...
    protected void finishPartialResults(byte[] state, int start, int len, DataOutput result)
        ...
        if (recordEval == null) {
            ...
            recordEval = new ClosedRecordConstructorEvalFactory.ClosedRecordConstructorEval(recType,
                    new IScalarEvaluator[] { evalSum, evalCount });
        }
