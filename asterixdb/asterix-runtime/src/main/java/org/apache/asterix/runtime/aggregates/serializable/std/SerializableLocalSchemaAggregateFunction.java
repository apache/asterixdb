...
public class SerializableLocalSchemaAggregateFunction extends AbstractSerializableAvgAggregateFunction {

    public SerializableLocalSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
