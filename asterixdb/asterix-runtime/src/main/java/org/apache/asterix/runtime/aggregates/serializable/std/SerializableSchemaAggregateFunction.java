...
public class SerializableSchemaAggregateFunction extends AbstractSerializableAvgAggregateFunction {

    public SerializableSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
