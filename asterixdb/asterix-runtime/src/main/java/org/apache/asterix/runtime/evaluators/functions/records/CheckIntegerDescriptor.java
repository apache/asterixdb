...
public class CheckIntegerDescriptor extends AbstractScalarFunctionDynamicDescriptor {
    ...
    public static final IFunctionDescriptorFactory FACTORY = CheckIntegerDescriptor::new;
                ...
                return new AbstractMultiTypeCheckEvaluator(args[0].createScalarEvaluator(ctx),
                    ...
                    public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
                        ...
                        if (isMatch(typeTag)) {
                            ...
                            throw new RuntimeDataException(ErrorCode.TYPE_UNSUPPORTED, sourceLoc, getIdentifier(),
    ...
    public FunctionIdentifier getIdentifier() {
        return BuiltinFunctions.CHECK_INTEGER;
    }
