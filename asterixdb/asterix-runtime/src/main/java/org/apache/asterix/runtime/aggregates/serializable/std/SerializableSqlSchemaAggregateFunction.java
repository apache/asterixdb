...
public class SerializableSqlSchemaAggregateFunction extends AbstractSerializableAvgAggregateFunction {

    public SerializableSqlSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
