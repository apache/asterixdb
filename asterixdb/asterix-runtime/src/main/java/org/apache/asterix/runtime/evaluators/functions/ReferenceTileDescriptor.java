                ...
                return new IScalarEvaluator() {
                    ...
                    public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
                        ...
                        if ((tag0 == ATypeTag.RECTANGLE) && (tag1 == ATypeTag.RECTANGLE) && (tag2 == ATypeTag.RECTANGLE)
                                && (tag3 == ATypeTag.RECTANGLE) && (tag4 == ATypeTag.BIGINT)
                                && (tag5 == ATypeTag.BIGINT)) {
                            ...
                            int rows = (int) AInt64SerializerDeserializer.getLong(bytes4, offset4 + 1);
                            int columns = (int) AInt64SerializerDeserializer.getLong(bytes5, offset5 + 1);
