...
public class IntervalIndexJoinOperatorDescriptorOld extends AbstractOperatorDescriptor {
    ...
    private static final Logger LOGGER = Logger.getLogger(IntervalIndexJoinOperatorDescriptorOld.class.getName());

    public IntervalIndexJoinOperatorDescriptorOld(IOperatorDescriptorRegistry spec, int memsize, int leftCountInFrames,
