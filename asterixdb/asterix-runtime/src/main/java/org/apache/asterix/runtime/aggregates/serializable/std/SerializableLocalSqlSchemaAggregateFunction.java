...
public class SerializableLocalSqlSchemaAggregateFunction extends AbstractSerializableAvgAggregateFunction {

    public SerializableLocalSqlSchemaAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
