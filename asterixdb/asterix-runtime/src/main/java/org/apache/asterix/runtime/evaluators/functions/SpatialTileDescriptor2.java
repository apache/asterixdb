...
public class SpatialTileDescriptor2 extends AbstractScalarFunctionDynamicDescriptor {
    private static final long serialVersionUID = 1L;

    public static final IFunctionDescriptorFactory FACTORY = new IFunctionDescriptorFactory() {
        @Override
        public IFunctionDescriptor createFunctionDescriptor() {
            return new SpatialTileDescriptor2();
        }
    };

    @Override
    public FunctionIdentifier getIdentifier() {
        return BuiltinFunctions.SPATIAL_TILE2;
    }
                    ...
                    public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
                        ...
                        if ((tag0 == ATypeTag.RECTANGLE) && (tag1 == ATypeTag.RECTANGLE) && (tag2 == ATypeTag.BIGINT)
                            ...
                            try {
                                ...
                                for (Integer tileId : tileValues) {
                                    listItemValue.reset();
                                    intSerde.serialize(new AInt32(tileId), listItemValue.getDataOutput());
