...
public class IcebergTableFilterPushdownProcessor extends ColumnFilterPushdownProcessor {

    public IcebergTableFilterPushdownProcessor(PushdownContext pushdownContext, IOptimizationContext context) {
