...
public class SqlppCompilationProvider implements ILangCompilationProvider {
    ...
    public Set<String> getCompilerOptions() {
        return new HashSet<>(Set.of(CompilerProperties.COMPILER_JOINMEMORY_KEY,
                ...
                CompilerProperties.COMPILER_CLUSTERBYMEMORY_KEY, CompilerProperties.COMPILER_PARALLELISM_KEY,
                CompilerProperties.COMPILER_SORT_PARALLEL_KEY, CompilerProperties.COMPILER_SORT_SAMPLES_KEY,
                CompilerProperties.COMPILER_EXTERNALSCANMEMORY_KEY, CompilerProperties.COMPILER_REWRITE_DISJUNCTION_KEY,
                ...
                CompilerProperties.COMPILER_QUERY_PLAN_CACHE_KEY, CompilerProperties.COMPILER_FRAMESIZE_KEY,
