...
public class SecondaryIndexBulkLoadExample {
    ...
    private static JobSpecification createJob(Options options) {
        ...
        TreeIndexDiskOrderScanOperatorDescriptor btreeScanOp = new TreeIndexDiskOrderScanOperatorDescriptor(spec,
                recDesc, storageManager, lcManagerProvider, closeableResourceManagerProvider, primarySplitProvider,
                primaryTypeTraits, dataflowHelperFactory, NoOpOperationCallbackProvider.INSTANCE);
        ...
        TreeIndexBulkLoadOperatorDescriptor btreeBulkLoad = new TreeIndexBulkLoadOperatorDescriptor(spec,
                storageManager, lcManagerProvider, closeableResourceManagerProvider, btreeSplitProvider,
                secondaryTypeTraits, comparatorFactories, fieldPermutation, 0.7f, false, dataflowHelperFactory,
