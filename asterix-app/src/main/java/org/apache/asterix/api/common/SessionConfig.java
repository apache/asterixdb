 ...
 * the execution of an APIFramework call. <li>It specifies how the execution will proceed (for instance, whether to optimize, or whether to execute at all). <li>It allows you specify where the primary execution output will be sent. <li>It also allows you to request additional output for optional out-of-band data about the execution (query plan, etc). <li>It allows you to specify the output format for the primary execution output - LOSSLESS_JSON, CSV, etc. <li>It allows you to specify output format-specific parameters.
 */
