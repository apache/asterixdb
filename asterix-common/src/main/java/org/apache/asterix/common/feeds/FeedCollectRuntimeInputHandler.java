...
public class FeedCollectRuntimeInputHandler extends ActiveRuntimeInputHandler {

    private final FeedFrameCache feedFrameCache;

    public FeedCollectRuntimeInputHandler(IHyracksTaskContext ctx, FeedConnectionId connectionId, ActiveRuntimeId runtimeId,
            IFrameWriter coreOperator, FeedPolicyAccessor fpa, boolean bufferingEnabled,
            FrameTupleAccessor fta, RecordDescriptor recordDesc, IActiveManager feedManager, int nPartitions)
            throws IOException {
